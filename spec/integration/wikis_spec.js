...
describe('routes : wikis', () =>
{
  ...
  //     describe('(not wiki creator)', () => 
  //     {
  //       it('should render a view with the selected wiki and not allow edit/delete', (done) =>
  //       {
  //         const options =
  //         {
  //           url: `${wikiBase}/${this.wiki2.slug}`,
  ...
  //           expect(body).toContain(this.wiki2.body);
  //           expect(body).not.toContain('Edit');
  //           expect(body).not.toContain(`/wiki/${this.wiki2.slug}/edit`);
  //           expect(body).not.toContain('Delete');
  //           expect(body).not.toContain(`/wiki/${this.wiki2.slug}/destroy`);
  //           done();
  //         });
  ...
  //     describe('(not wiki creator)', () =>
  //     {
  //       it('should not render an edit view for the selected wiki and redirect to wiki page with auth error', (done) =>
  //       {
  //         const options = 
  //         {
  //           url: `${wikiBase}/${this.wiki2.slug}/edit`,
  ...
  //           expect(body).not.toContain('Edit Wiki');
  //           expect(body).not.toContain(`/wiki/${this.wiki2.slug}/update`);
  //           done();
  //         });
  //       });
  //     });
  ...
  //         expect(this.wiki1.title).toBe('Test Wiki');
  //         expect(this.wiki1.body).toBe('Long Test Wiki Body :)');
  ...
  //     describe('(not wiki creator)', () =>
  //     {
  //       it('should not update wiki and redirect to the wiki page with auth', (done) =>
  //       {
  //         const newWikiTitle = 'Test Wiki Updated';
  //         const newWikiBody = 'Test Long Test Wiki Body :) Test Long Test Wiki Body :) Test Long Test Wiki Body :) Test Long Test Wiki Body :) Test Long Test Wiki Body :) Test Long Test Wiki Body :)';
  ...
  //           expect(body).toContain(AUTHORIZATION_MESSAGE);
  //           expect(res.request.uri.href).toBe(`${wikiBase}/${this.wiki2.slug}`);
  //           expect(body).not.toContain(newWikiTitle);
  //           expect(body).not.toContain(newWikiBody);

  //           Wiki.findByPk(this.wiki2.id)
  //           .then((wiki) =>
  //           {
  //             expect(wiki.title).toBe(this.wiki2.title);
  //             expect(wiki.body).toBe(this.wiki2.body);
  //             done();
  //           })
  //           .catch((err) =>
  //           {
